...
The blind-install archive can optionally use a config file named `venus-data-opkg-manager-blind-install.conf` placed next to `venus-data-opkg-manager-blind-install.tgz` file on the USB drive.
