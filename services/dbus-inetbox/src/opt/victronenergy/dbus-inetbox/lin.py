...
# Same approach for the raw PID 0xD8. This corresponds to a PID 0x18
    ...
    def __init__(self, app : inetboxapp.InetboxApp, port : str, tasks : TaskManager, lin_debug):
        self.loop_state = False
        self.serial = serial.Serial(port, baudrate=9600, bytesize=8, parity=serial.PARITY_NONE, stopbits=serial.STOPBITS_ONE, timeout=0.03)
...
# Same approach for the raw PID 0xD8. This corresponds to a PID 0x18
    ...
    async def _loop_serial(self):
        ...
        if raw_pid in self.DISPLAY_STATUS_PIDS: 
            print(f"status-message found with {raw_pid:x}")#0x20 0x61 0xe2 
