...
Item {
    ...
    //property color textColor: Theme.color_button
    //property color selectedColor: Theme.color_button
    ...
    Row {
        ...
        Repeater {
            ...
            delegate: Button {
                ...
                text: root.labelFor(model, index)
                checkable: true
            ...
            /*
                contentItem: Text {
                    text: parent.text
                    font.pixelSize: 12
                    color: checked ? root.selectedTextsColor : root.textsColor
                ...
                background: Item {
                    ...
                    Canvas {
                        ...
                        onPaint: {
                            ...
                            ctx.closePath();
                            //ctx.fillStyle = checked ? root.selectedsColor : "transparent";
                            ctx.fillStyle = enabled ? (down ? Theme.color_ok : Theme.color_darkOk)
