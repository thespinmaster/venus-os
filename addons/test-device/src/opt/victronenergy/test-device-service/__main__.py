...
from dbus_test_device_service import DbusTestDeviceService
...
def main():
	...
	mainloop.run()
	log.info("EXITED: test-device")

def getArgs():
	parser = ArgumentParser(description="test-device-service", add_help=True)
