...
ListSetting {
	...
	function click() {
		...
		if (interactive) {
			var device = devices.deviceForDeviceInstance(deviceInstanceItem.value)
			Global.pageManager.pushPage("qrc:/OpkgManager/OpkgDevicesettings.qml",
	...
	property string customDevicePrefix: Global.systemSettings.serviceUid + "/Settings/Devices/sid_" + modelData
